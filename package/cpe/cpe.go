...
// describing where slp got the Attributes, e.g. generated by heuristics
...
const (
	GeneratedSource           Source = "slp-generated"
...
func newWithoutValidation(cpeStr string) (Attributes, error) {
	...
	CPE := fromAttributes(*value)

	// we need to compare the raw data since we are constructing CPEs in other locations
	CPE.Vendor = normalizeField(CPE.Vendor)
	CPE.Product = normalizeField(CPE.Product)
	CPE.Language = normalizeField(CPE.Language)
	CPE.Version = normalizeField(CPE.Version)
	CPE.TargetSW = normalizeField(CPE.TargetSW)
	CPE.Part = normalizeField(CPE.Part)
	CPE.Edition = normalizeField(CPE.Edition)
	CPE.Other = normalizeField(CPE.Other)
	CPE.SWEdition = normalizeField(CPE.SWEdition)
	CPE.TargetHW = normalizeField(CPE.TargetHW)
	CPE.Update = normalizeField(CPE.Update)
